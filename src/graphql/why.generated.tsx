...
export type WhyBlockCollectionQuery = { __typename?: 'Query', whyBlockCollection?: { __typename?: 'WhyBlockCollection', items: Array<{ __typename?: 'WhyBlock', title?: string | null, description?: { __typename?: 'WhyBlockDescription', json: any } | null, icon?: { __typename?: 'Asset', url?: string | null, description?: string | null } | null } | null> } | null };
